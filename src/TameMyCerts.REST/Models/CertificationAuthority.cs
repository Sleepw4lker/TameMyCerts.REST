...
public partial class CertificationAuthority : IEnrollmentSubject
{
    ...
    ///     The raw security descriptor of the pKIEnrollmentService Active Directory object, to determine
    ///     enrollment permissions from. This does not carry CA security permissions (Manage CA / Issue and
    ///     Manage Certificates / Read) - those live only on the certification authority itself; see
    ///     <see cref="ICertificationAuthorityGateway.AllowsForCertificateManagement" />.
    /// </param>
