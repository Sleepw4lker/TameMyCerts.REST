...
namespace TameMyCerts.REST
{
    ...
    public static class Logger
    {
        ...
        public static void Log(Exception ex)
        {
            ...
            eventLog.WriteEntry(
                string.Format(LocalizedStrings.DESC_UNHANDLED_EXCEPTION, ex.Message,
                    HttpContext.Current.User.Identity.Name, GetClientIpAddress(), HttpContext.Current.Request.UserAgent,
